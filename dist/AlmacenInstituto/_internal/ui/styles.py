...
COLORS = {
    ...
    'text_secondary': '#334155', # Texto secundario - MÁS OSCURO para mejor contraste
    'text_muted': '#64748b',   # Texto atenuado - MÁS OSCURO para mejor contraste
    'text_table_header': '#1e293b', # Texto de encabezados de tabla - MUY OSCURO
    ...
    'table_header_bg': '#f1f5f9', # Fondo de encabezados de tabla
    'table_row_even': '#ffffff',   # Fondo de filas pares
    'table_row_odd': '#f8fafc'    # Fondo de filas impares
}
...
TABLE_STYLES = {
    ...
    'row_even': {
        'bg': COLORS['table_row_even'],
        'fg': COLORS['text_primary']
    },
    'row_odd': {
        'bg': COLORS['table_row_odd'],
        'fg': COLORS['text_primary']
    },
    'selected': {
        'bg': COLORS['primary_light'],
...
# Estilos para Treeview (tablas de tkinter)
TREEVIEW_STYLES = {
    'header': {
