...
class ReportesPanel(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        btn_style = {"fg": "#fff", "font": ("Segoe UI", 11, "bold"), "relief": "flat", "padx": 12, "pady": 4}
        tk.Button(btn_frame, text="Reporte Inventario", command=self.reporte_inventario, bg="#1976d2", activebackground="#1565c0", **btn_style).pack(side='left', padx=8)
        tk.Button(btn_frame, text="Reporte Movimientos", command=self.reporte_movimientos, bg="#43a047", activebackground="#388e3c", **btn_style).pack(side='left', padx=8)
        tk.Button(btn_frame, text="Reporte SIGA", command=self.reporte_siga, bg="#ab47bc", activebackground="#8e24aa", **btn_style).pack(side='left', padx=8)
